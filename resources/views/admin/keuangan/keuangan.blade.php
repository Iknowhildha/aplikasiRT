        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $data->sum('uang_masuk') - $data->sum('uang_keluar') }}</td>
                    <td>
            ...
            <tfoot>
                <tr>
                  <th colspan="3">Total Saldo, Uang Masuk & Keluar</th>
                  <td style="background-color:green; color:white">@if ($keuangan->total() > 0) {{ number_format($data->sum('uang_masuk')) }} @else 0 @endif  </td>
                  <td style="background-color:red; color:white"> @if ($keuangan->total() > 0)  {{ number_format($data->sum('uang_keluar')) }} @else 0 @endif </td>
                  <td style="background-color:blue; color:white" colspan="2"> @if ($keuangan->total() > 0) {{ number_format($data->sum('uang_masuk') - $data->sum('uang_keluar')) }} @else 0 @endif </td>
                </tr>
            </tfoot>
        </table>
        <br>
